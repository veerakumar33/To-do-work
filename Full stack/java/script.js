...
otherLink.addEventListener("click", function () { handleSectionLinkClick("other", otherLink); });
    ...
    // Ensure the form is handled via JavaScript (prevent default form submission)
    document.querySelector('form').addEventListener('submit', async (e) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                // Redirect to index.html (or /todolist)
...
async function addTask(taskText, dueDate) {
    ...
    try {
        ...
        if (response.ok) {
            ...
            displayTask(newTask); // Display the newly added task in the UI
        } else {
...
// Function to call when the user submits a task
